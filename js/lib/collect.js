...
(function() {
  var collect, collectProperties, collectValues, each, ensurePromise, fail, fulfill, getTypeOf, isPromise, _ref;

  _ref = require("./utilities"), fulfill = _ref.fulfill, fail = _ref.fail, ensurePromise = _ref.ensurePromise, isPromise = _ref.isPromise;
  ...
  collectProperties = function(object) {
    var name, newProperties, promiseNames, promises, promisesIndex, value;
    ...
    promises = (function() {
      ...
      _results = [];
      for (name in promisesIndex) {
        value = promisesIndex[name];
        _results.push(value);
      }
      return _results;
    })();
    promiseNames = Object.keys(promisesIndex);
    return each(promises, (function(p) {
      return p;
    }), {
      handleResult: function(value, i) {
        return newProperties[promiseNames[i]] = value;
      },
      getFinalValue: function() {
